...
public class GameScreen extends Screen {
	...
	public final void initialize() {
		...
		this.ship = new Ship(this.width / 4, this.height - 30, 1);
		this.ship2 = new Ship(this.width * 3 / 4, this.height - 30, 2);
		this.ship2.setColor(Color.CYAN);
	...
	protected final void update() {
		...
		cleanBullets();
		draw();
		if(this.lives == 0) ship.destroy();
		if(this.lives2 == 0) ship2.destroy();
	...
	public final GameState getGameState() {
		return new GameState(this.level, this.score, this.score2,
				this.lives, this.lives2,
				this.bulletsShot, this.bulletsShot2,
				this.shipsDestroyed, this.shipsDestroyed2);
	}
}